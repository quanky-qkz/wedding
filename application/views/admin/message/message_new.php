    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="box">
                ...
                <a class="btn btn-primary" href="<?php echo site_url('message/inbox');?>">Inbox</a>
                <a class="btn btn-primary" href="<?php echo site_url('message/sent');?>">Sent</a>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <div class="box box-primary">
                                ...
                                <!-- form start -->
                                <form role="form" id="form" method="post" action="<?php echo site_url('message/doAdd');?>">
                                    <div class="box-body">
